...
\textbf{Reproducibility:} Of 52 studies: only 25.0\% (13/52) released source code, despite 92.3\% (48/52) describing reproducible methods, 94.2\% (49/52) documenting preprocessing steps, and 67.3\% (35/52) performing statistical analysis.
