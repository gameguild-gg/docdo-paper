  ...
  **METHODS**                                                                        
  ...
  Eligibility        5        Specify the inclusion and exclusion criteria for the   
  criteria                    review and how studies were grouped for the syntheses. 

  Information        6        Specify all databases, registers, websites,            
  ...
  Selection process  8        Specify the methods used to decide whether a study met 
                              the inclusion criteria of the review, including how    
  ...
  Data collection    9        Specify the methods used to collect data from reports, 
  ...
  Data items         10a      List and define all outcomes for which data were       
                              ...
                              compatible with each outcome domain in each study were 
  ...
  Study risk of bias 11       Specify the methods used to assess risk of bias in the 
  ...
  Synthesis methods  13a      Describe the processes used to decide which studies    
                     ...
                     13d      Describe any methods used to synthesize results and    
                              provide a rationale for the choice(s). If              
                              meta-analysis was performed, describe the model(s),    
  ...
  Reporting bias     14       Describe any methods used to assess risk of bias due   
  assessment                  to missing results in a synthesis (arising from        
                              reporting biases).                                     

  Certainty          15       Describe any methods used to assess certainty (or      
  ...
  **RESULTS**                                                                        
  ...
  Study              17       Cite each included study and present its               
  characteristics             characteristics.                                       

  Risk of bias in    18       Present assessments of risk of bias for each included  
  studies                     study.                                                 

  Results of         19       For all outcomes, present, for each study: (a) summary 
  individual studies          statistics for each group (where appropriate) and (b)  
  ...
  syntheses                   characteristics and risk of bias among contributing    
                              studies.                                               

                     20b      Present results of all statistical syntheses           
                              conducted. If meta-analysis was done, present for each 
                              the summary estimate and its precision (e.g.           
  ...
  Certainty of       22       Present assessments of certainty (or confidence) in    
  ...
  **OTHER                                                                            
  ...
  Registration and   24a      Provide registration information for the review,       
  ...
  Availability of    27       Report which of the following are publicly available   
  data, code and              and where they can be found: template data collection  
