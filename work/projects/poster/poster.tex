...
\begin{center}
  \begin{minipage}[t]{0.48\linewidth}
    \begin{statchip}{Studies Reviewed (2015--2025)}
      52
    \end{statchip}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.48\linewidth}
...
\begin{tabular}{@{}ll@{}}
  \textbf{Literature window:}    & 2015--2025 \\
  \textbf{Full-text retrieval:}  & 39.1\% \\
  \textbf{Human audit:}          & $\kappa=0.89$, n\,=\,64, 10\% stratified \\
                                 & 2 domain experts, blind to AI decisions \\
\end{tabular}
}
\vspace{0.2em}
\begin{notebox}[utadred]
{\footnotesize
\textbf{PRISMA 2020 Adaptations}\\[3pt]
\setlength{\tabcolsep}{3pt}
\renewcommand{\arraystretch}{0.9}
\begin{tabular}{@{}p{0.45\linewidth}p{0.55\linewidth}@{}}
\textit{Standard} & \textit{This survey} \\
\midrule
Prospective SR & Structured survey, no registration \\
Dual human reviewers       & Elasticsearch + GPT-4o/5 pipeline \\
ROBINS-I / RoB~2           & Custom 3D quality rubric (0--30) \\
Dual independent extraction & Single GPT-5.2 batch pass per PDF \\
Pooled effect sizes         & Narrative synthesis only, Dice/HD95 \\
\end{tabular}
}
\end{notebox}
\end{pblock}
...
\textbf{BTCV}        & Beyond the Cranial Vault, 30-scan 13-organ benchmark\\
\textbf{CNN}         & Convolutional Neural Network \\
\textbf{CT / 3D}     & Computed tomography volume \\
\textbf{Dice}        & $2|A\cap B|/(|A|+|B|)$; 1.0\,=\,perfect \\
\textbf{DICOM}       & Clinical imaging file/transport standard \\
\textbf{DL}          & Deep Learning \\
\textbf{EAU}         & European Assoc.\ of Urology \\
\textbf{Foundation}  & Large pre-trained, promptable model (e.g.\ MedSAM) \\
\textbf{HD95}        & 95th-\%ile Hausdorff dist.\ (mm) \\
\textbf{$\kappa$}    & Inter-rater agreement (Cohen's) \\
\textbf{MC-Drop.}    & Monte-Carlo Dropout \\
\textbf{MedSAM}      & Fine-tuned SAM for medical image segmentation \\
\textbf{nnU-Net}     & Self-config.\ U-Net \\
...
\textbf{Transformer} & Self-attention model (UNETR, Swin UNETR) \\
\textbf{TTA}         & Test-Time Augmentation \\
\textbf{U-Net}       & Encoder-decoder with skip connections \\
\end{tabular}
\end{tcolorbox}
...
\begin{pblock}{Clinical Deployment Barriers}
...
%--- Recommendations ---------------------------------------------------------
\begin{pblock}{Phased Adoption Strategy for \newline Surgical Planning Platforms}
...
\begin{tcolorbox}[colback=utadnavy!10,colframe=utadnavy,arc=4pt,boxrule=1.2pt,
  top=4pt,bottom=4pt,left=7pt,right=7pt,before={\vskip0pt},after={\vskip0pt}]
  {\normalsize\bfseries\color{utadnavy!80!black} 2. Uncertainty-Guided Quality Assurance}\\[2pt]
...
\begin{itemize}\setlength\itemsep{-2pt}\setlength\topsep{0pt}\setlength\parsep{0pt}
  \item Ronneberger et al.\ \emph{U-Net.} MICCAI, 2015.
  \item Landman et al.\ \emph{BTCV Challenge.} MICCAI WS, 2015.
  \item He et al.\ \emph{ResNet.} CVPR, 2016.
  \item Milletari et al.\ \emph{V-Net.} 3DV, 2016.
  \item Litjens et al.\ \emph{Survey DL Med.\ Imaging.} Med.\ Image Anal., 2017.
  \item Oktay et al.\ \emph{Attention U-Net.} MIDL, 2018.
  \item Gibson et al.\ \emph{Dense V-Net Multi-Organ.} IEEE TMI, 2018.
  \item Porpiglia et al.\ \emph{3D Virtual Renal Imaging.} BJU Int., 2018.
  \item Isensee et al.\ \emph{nnU-Net.} Nat.\ Methods, 2021.
  \item Liu et al.\ \emph{Swin Transformer.} ICCV, 2021.
  \item Page et al.\ \emph{PRISMA 2020.} BMJ, 2021.
  \item Hatamizadeh et al.\ \emph{UNETR.} WACV, 2022.
  \item Hatamizadeh et al.\ \emph{Swin UNETR.} MICCAI WS, 2022.
  \item Roy et al.\ \emph{MedNeXt.} MICCAI, 2023.
  \item Wasserthal et al.\ \emph{TotalSegmentator.} Radiol.\ AI, 2023.
  \item Huang et al.\ \emph{STU-Net.} arXiv, 2023.
  \item Kirillov et al.\ \emph{Segment Anything.} arXiv, 2023.
  \item Shamshad et al.\ \emph{Transformers in Med.\ Imaging.} Med.\ Image Anal., 2023.
  \item {European Assoc.\ Urology.} \emph{EAU Guidelines RCC.} Eur.\ Urol., 2023.
  \item Chen et al.\ \emph{TransUNet.} Med.\ Image Anal., 2024.
  \item Ma et al.\ \emph{MedSAM.} Nat.\ Commun., 2024.
\end{itemize}
}
\end{pblock}
